        ...
        <yd-cell-group v-for="(v,index1) in  arrinfo" :key="index1">
        	<div class="header_text">
        		...
        		<div class="h_ping">
        			...
        			<div class="h_xing">
        				  <yd-cell-item>
           						 <yd-rate slot="left" v-model="states"  :key="index1"></yd-rate>
            ...
            <yd-cell-item style="border-radius: 10px;padding: 0px 10px;background-color: #fff;">
                <yd-textarea :show-counter="false" slot="right" v-model="rates" placeholder="Write down the experience and use the experience to help other small partners ~
...
//      	console.log(this.imgList); 
          ...
          this.allinfo=[];
        	this.allinfo.push({
             goods_id:this.arrinfo[0].goods_id,
			 img:imgtu,
             contents:this.rates,
              point:this.states
            });
           let main= JSON.stringify(this.allinfo);
            console.log(main);
				var url = 'api/v1/user/addComment';
				var param = qs.stringify({
					  content: main,
              		  service_point:this.rate1,
             		  delivery_point:this.rate2,
             		  order_no:this.shopdetil.order_no,
				});
...
//        this.images = file.src
        ...
        poinorder(){
//      	window.location.href="./orderlist.html?type=coms";
			window.location.href="./orderlist.html?type=coms";
        }
//      bytesToSize(bytes) {
