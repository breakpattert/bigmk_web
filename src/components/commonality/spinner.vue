<style>
    .yd-spinner >a.ivu-input-number-handler-up-disabled:after{
        color: #ddd;
    }

    .yd-spinner >a.ivu-input-number-handler-down-disabled:after{
        color: #ddd;
    }
...
<template>
    <div>
        <div class="yd-flexbox-item yd-flexbox-item-center">
            <span class="yd-spinner" style="height: 0.6rem; width: 2rem;">
                 ...
                 <a
                         ...
                         :class="downClasses">
                <span @click="preventDefault"></span>
                </a>
            ...
            <input
                    ...
                    <a
                            ...
                            @mousedown="preventDefault"
                            :class="upClasses">
                <span :class="innerUpClasses" @click="preventDefault"></span></a>
            </span>
        </div>
    </div>
</template>
